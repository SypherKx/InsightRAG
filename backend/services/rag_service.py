                        ...
                        cloud_messages = [
                            {
                                ...
                                "content": (
                                    ...
                                    "3. Format with a direct executive overview, clean markdown sections (###), structured emoji bullet anchors (🎯 Objective, 🛠️ Tech Stack, ⚡ Highlights, 📊 Impact), and comparison tables.\n"
                                    "4. Synthesize facts into coherent, articulate explanations without repeating boilerplate headings.\n"
                                    "5. Never output disclaimers saying you cannot display images; visual cards are automatically rendered by the UI.\n"
                                    "6. Include exact numbers, metrics, and page references whenever present."
                                )
                            }
                        ]
