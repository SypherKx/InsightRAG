      ...
      <div className="mx-auto max-w-7xl px-6">
        ...
        <div className="grid gap-12 md:grid-cols-4">
          <div className="flex flex-col gap-3 text-sm">
            ...
            <a
              href="/#download-locally"
              className="text-[var(--on-dark-soft)] hover:text-[var(--on-dark)] transition"
            >
          ...
          <div className="flex flex-col gap-3 text-sm">
            <div className="caption-uppercase text-[var(--on-dark-soft)] mb-1">
              Research & Privacy
            </div>
            <a
              href="#"
        ...
        <div className="mt-16 border-t border-white/10 pt-8 flex flex-col md:flex-row md:items-center justify-between text-xs text-[var(--on-dark-soft)]">
          <div>
            © {new Date().getFullYear()} InsightRAG AI. Made by{" "}
            <span className="text-white">Karan Pratap Singh</span>.
          </div>
