...
export function DocsPage() {
  ...
  const navGroups = [
    ...
    {
      title: "Developers",
      items: [{ id: "api", label: "REST API Reference", icon: Code }],
    },
  ];
        ...
        <main className="col-span-1 md:col-span-8 lg:col-span-9 space-y-12 min-w-0">
          ...
          <section id="quickstart" className="scroll-mt-24 space-y-6">
            <div className="bg-white border-3 border-black rounded-2xl p-6 sm:p-8 shadow-[6px_6px_0px_#000] space-y-6">
              ...
              <p className="text-sm sm:text-base text-gray-800 leading-relaxed font-sans font-medium">
                <strong>InsightRAG AI</strong> is an autonomous, multimodal local-first RAG
                generator. It indexes PDFs, Word documents, and images on your machine with zero
                mandatory API costs. By default, it runs locally with Ollama and on-device
                embeddings, while offering optional cloud API fallbacks (OpenAI, Gemini, Groq,
                Claude) whenever you want higher reasoning capabilities.
              </p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 pt-4">
                <div className="bg-[#ffe600]/20 border-2 border-black p-4 rounded-xl space-y-1.5 shadow-[3px_3px_0px_#000]">
                  ...
                  <p className="text-xs text-gray-700 leading-relaxed font-medium">
                    Detects available NVIDIA VRAM, Apple Silicon MPS, or CPU cores to configure
                    quantization.
                  </p>
                </div>
                ...
                <div className="bg-pink-50 border-2 border-black p-4 rounded-xl space-y-1.5 shadow-[3px_3px_0px_#000]">
                  ...
                  <p className="text-xs text-gray-700 leading-relaxed font-medium">
                    Launches the factory web studio on{" "}
          ...
          <section id="architecture" className="scroll-mt-24 space-y-6">
            <div className="bg-white border-3 border-black rounded-2xl p-6 sm:p-8 shadow-[6px_6px_0px_#000] space-y-6">
              ...
              <p className="text-sm text-gray-700 leading-relaxed font-medium">
                InsightRAG AI uses a multi-tier pipeline engineered to prevent hallucinations while
                extracting textual information, mathematical formulas, and visual diagrams:
              </p>
              ...
              <div className="space-y-3 font-mono text-xs">
                <div className="bg-white border-2 border-black p-4 rounded-xl shadow-[3px_3px_0px_#000] flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                  <div className="flex items-center gap-3">
                    <span className="bg-black text-white font-black px-2.5 py-1 rounded-lg text-xs">
                      1
                    </span>
                    <div>
                      <span className="font-black text-sm text-black">INGESTION</span>
                      <div className="text-gray-600 text-xs mt-0.5">
                        PDF / Word / Images → PyMuPDF Vector Clustering + RapidOCR
                      </div>
                    </div>
                  </div>
                ...
                <div className="bg-white border-2 border-black p-4 rounded-xl shadow-[3px_3px_0px_#000] flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <div className="text-gray-600 text-xs mt-0.5">
                        Local SentenceTransformer → Embedded FAISS / ChromaDB Store
                      </div>
                    </div>
                  </div>
                ...
                <div className="bg-white border-2 border-black p-4 rounded-xl shadow-[3px_3px_0px_#000] flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <div className="text-gray-600 text-xs mt-0.5">
                        Multi-Turn Query Attention + HyDE Expansion
                      </div>
                    </div>
                  </div>
                ...
                <div className="bg-white border-2 border-black p-4 rounded-xl shadow-[3px_3px_0px_#000] flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <div className="text-gray-600 text-xs mt-0.5">
                        Local Ollama LLM + Grounding Verification
                      </div>
                    </div>
                  </div>
          ...
          <section id="hardware" className="scroll-mt-24 space-y-6">
            <div className="bg-white border-3 border-black rounded-2xl p-6 sm:p-8 shadow-[6px_6px_0px_#000] space-y-6">
              ...
              <p className="text-sm text-gray-700 leading-relaxed font-medium">
                Rather than failing on resource-constrained machines, the hardware engine
                automatically scales quantization and model parameters to fit your machine's exact
                specifications:
              </p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="bg-emerald-50 border-2 border-black p-5 rounded-xl space-y-2 shadow-[3px_3px_0px_#000]">
                  ...
                  <p className="text-xs text-gray-700 leading-relaxed">
                    Runs <strong>Qwen2.5 (7B / 14B)</strong> with full context windows and
                ...
                <div className="bg-amber-50 border-2 border-black p-5 rounded-xl space-y-2 shadow-[3px_3px_0px_#000]">
                  ...
                  <p className="text-xs text-gray-700 leading-relaxed">
                    Selects <strong>Llama3.2 (3B)</strong> with Q4_K_M quantization for rapid
                    inference and low memory overhead.
                  </p>
                </div>
                ...
                <div className="bg-blue-50 border-2 border-black p-5 rounded-xl space-y-2 shadow-[3px_3px_0px_#000]">
                  ...
                  <p className="text-xs text-gray-700 leading-relaxed">
                    Employs <strong>CPU ONNX runtime</strong>, multi-threaded batching, and
                    lightweight 1.5B/3B models.
                  </p>
                </div>
              </div>
            </div>
          ...
          <section id="multimodal" className="scroll-mt-24 space-y-6">
            <div className="bg-white border-3 border-black rounded-2xl p-6 sm:p-8 shadow-[6px_6px_0px_#000] space-y-6">
              ...
              <p className="text-sm text-gray-700 leading-relaxed font-medium">
                Standard RAG solutions discard charts, flowcharts, and math formulas by stripping
                PDFs down to plain text. InsightRAG AI uses an object-level layout detector to
                isolate, crop, and index diagrams alongside text.
              </p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 font-mono text-xs">
                ...
                <div className="bg-white border-2 border-black p-4 rounded-xl space-y-2 shadow-[3px_3px_0px_#000]">
                  ...
                  <p className="text-gray-600 leading-relaxed">
                    Matches diagram bounding boxes to nearby figure captions (e.g.{" "}
                    <em>Figure 2: Architecture Overview</em>).
                  </p>
                </div>
                ...
                <div className="bg-white border-2 border-black p-4 rounded-xl space-y-2 shadow-[3px_3px_0px_#000]">
                  ...
                  <p className="text-gray-600 leading-relaxed">
                    Allows users to paste or upload an image (Ctrl+V) to find matching diagrams and
                    formulas across documents.
                  </p>
                </div>
              </div>
            </div>
          ...
          <section id="guardrails" className="scroll-mt-24 space-y-6">
            <div className="bg-white border-3 border-black rounded-2xl p-6 sm:p-8 shadow-[6px_6px_0px_#000] space-y-6">
              <div className="flex items-center gap-2">
                ...
                <span className="text-gray-400 font-mono text-xs font-bold">
                  // Anti-Hallucination & Local Privacy
                </span>
              </div>
              ...
              <p className="text-sm text-gray-700 leading-relaxed font-medium">
                Cloud models frequently reject sensitive or proprietary documents due to third-party
                data transmission policies. InsightRAG AI provides a local-first pipeline where
                document chunking, visual layout detection, and vector indexing always remain
                private on your machine, with optional BYOK cloud models for synthesis.
              </p>
              ...
              <div className="bg-gray-50 border-2 border-black p-5 rounded-xl space-y-3 shadow-[3px_3px_0px_#000]">
                ...
                <p className="text-xs sm:text-sm text-gray-700 leading-relaxed">
                  Every generated response is cross-checked against retrieved source chunks. Answers
                  unsupported by source text are flagged with confidence metrics and grounded
                  badges.
                </p>
              </div>
            </div>
          ...
          <section id="standalone" className="scroll-mt-24 space-y-6">
            <div className="bg-white border-3 border-black rounded-2xl p-6 sm:p-8 shadow-[6px_6px_0px_#000] space-y-6">
              ...
              <p className="text-sm text-gray-700 leading-relaxed font-medium">
                Once your knowledge base is indexed in the factory studio, you can export a
                self-contained ZIP bundle that operates standalone on local hardware with zero
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                  <div className="bg-white border-2 border-black p-3.5 rounded-xl shadow-[2px_2px_0px_#000] space-y-1">
                    ...
                    <p className="text-gray-600 text-xs">
                      Pre-indexed ChromaDB / FAISS vector database with all document embeddings.
                    </p>
                  </div>
                  ...
                  <div className="bg-white border-2 border-black p-3.5 rounded-xl shadow-[2px_2px_0px_#000] space-y-1">
                    ...
                    <p className="text-gray-600 text-xs">
                      Standalone FastAPI microservice with persistent LocalStorage auto-save and
                      Quit controls.
                    </p>
                  </div>
                </div>
              ...
              <div className="space-y-2 pt-2">
                <div className="font-mono font-bold text-xs text-black uppercase">
          ...
          <section id="api" className="scroll-mt-24 space-y-6">
            <div className="bg-white border-3 border-black rounded-2xl p-6 sm:p-8 shadow-[6px_6px_0px_#000] space-y-6">
              ...
              <p className="text-sm text-gray-700 leading-relaxed font-medium">
                Integrate the InsightRAG engine into your own frontends, Discord bots, or internal
                tools using the standard REST API:
              </p>
                  ...
                  <table className="w-full text-left font-mono text-xs">
                    ...
                    <tbody className="divide-y-2 divide-black bg-white font-medium">
                      ...
                      <tr>
                        ...
                        <td className="p-3 text-gray-700">
                          Exports the turnkey standalone ZIP package.
                        </td>
                      </tr>
                      <tr>
                        <td className="p-3 border-r-2 border-black">
          ...
          <footer className="border-3 border-black bg-white p-5 rounded-2xl shadow-[4px_4px_0px_#000] flex flex-col sm:flex-row items-center justify-between gap-4 font-mono text-xs text-gray-700">
            <div className="font-bold text-black">InsightRAG Autonomous Multimodal RAG Engine</div>
            <div>
              Made by <span className="font-bold text-black">Karan Pratap Singh</span>
            </div>
            <div className="text-gray-500">MIT License • Local First</div>
          </footer>
        </main>
      </div>
    </div>
